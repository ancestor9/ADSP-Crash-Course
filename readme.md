...
| 11 | 딥러닝 기초와 학습 메커니즘 1| 인공 신경망(ANN)의 구조 ([퍼셉트론](https://www.101ai.net/nnet/perceptron), 다층 신경망), 활성화 함수 (ReLU, Sigmoid, Softmax)의 역할| |
| 12 | 딥러닝 기초와 학습 메커니즘 2| 손실 함수(Loss Function): MSE와 Cross-Entropy, 최적화(Optimization): 경사하강법(Gradient Descent), [역전파(Backpropagation)](https://www.101ai.net/nnet/backprop)| |

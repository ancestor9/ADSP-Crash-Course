...
| # | 내용 | 참고 자료 |
|:----:|:-----------|--------|
| 01 | 회귀(Regression), 회귀계수, [MSE](https://www.101ai.net/basics/loss-metric), 분류(Classification), 분산과 편향, [자료스케일링](https://www.101ai.net/basics/data-scaling) |  [Linear Regression](https://www.101ai.net/basics/linear-regression), [linear-regression](https://mlu-explain.github.io/linear-regression/)  [k-neighbors-classification](http://vision.stanford.edu/teaching/cs231n-demos/knn/) |
...
| 11 |  딥러닝 기초와 학습 메커니즘 | 인공 신경망(ANN)의 구조 (퍼셉트론, 다층 신경망), 활성화 함수 (ReLU, Sigmoid, Softmax)의 역할| |
| 12 |  딥러닝 기초와 학습 메커니즘 | 손실 함수(Loss Function): MSE와 Cross-Entropy, 최적화(Optimization): 경사하강법(Gradient Descent), 역전파(Backpropagation)의 개념| |
